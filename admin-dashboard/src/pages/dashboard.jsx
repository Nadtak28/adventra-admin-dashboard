...
export default function Dashboard() {
    ...
    return (
        <div className="space-y-6 bg-[#0b1520] min-h-screen -m-6 p-6 -mx-6">
            ...
            <StatsCards month={dashBoard.month} isLoading={dashBoard.isLoading}/>
            <Chart/>
            ...
            <FrequentBookers bookersEvents={dashBoard.mostEventsBooker} bookersGroupTrips={dashBoard.mostGroupTripsBooker} bookersTab={bookersTab} setBookersTab={setBookersTab} />
        </div>
    );
}